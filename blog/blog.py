...
# handler for url like host/blog or host/blog/
class BlogFront(BlogHandler):
    def get(self):
        # TODO: zx url like /flush will flush all memcache
        if 'flush' in self.request.url:
            memcache.flush_all()
...
# handler for single blog, url like host/blog/blog_id
...
# handler for create new post, url like host/blog/newpost
class NewPost(BlogHandler):
    ...
    def post(self):
        if not self.user:
            self.redirect("/blog")
        # get data from form post info based on element name, etc subject
